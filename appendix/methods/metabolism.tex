...
\multicolumn{4}{l}{\bfseries Feedback modes} \\
\cmidrule(lr){1-1}
...
\toprule
    %\multirow{2}{*}{\bfseries Feedback \newline mode} 
    & \multicolumn{4}{c}{\bfseries Condition}\\ 
    \cmidrule(lr){2-5}
...
\toprule
    & \multicolumn{3}{c}{\bfseries Condition}\\ 
    \cmidrule(lr){2-4}
	...
	\multicolumn{4}{l}{\bfseries Feedback strengths}\\ 
	\cmidrule(lr){1-1}    
