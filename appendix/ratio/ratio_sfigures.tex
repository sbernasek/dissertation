...
%\caption[PntGFP and Yan expression dynamics in differentiating cone cells.]{\textbf{PntGFP and Yan expression dynamics in differentiating C1/C2 and C3/C4 cone cells.} Construction is equivalent to Figure \ref{fig:ratio:figS2a}C-E.}
%\label{fig:ratio:figS2b}
%\end{figure}
